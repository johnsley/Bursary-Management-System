$(document).ready(function(){
	...
	$error1 = $('<center><label class = "text-danger">Invalid username or password! Try again.</label></center>');
	$error2 = $('<center><label class = "text-danger">Student Not Found</label></center>');
	$error3 = $('<center><label class = "text-danger">User Not Found</label></center>');
...
/*   Administrator Login  */	
	$('#login').click(function(){
		...
		if($username == "" && $password == "" && $usertype == ""){
			...
			setTimeout(function(){	
				$.post('check_superadmin.php',{username: $username, password: $password},
					function(result){
						if(result == "Success"){
