           ...
           <!--  <div class="row">
            ...
            <div class="row">
                ...
                <div id = "act_form" style = "display:none;" class = "panel panel-default">
                    <div  class = " panel-heading" >    
                        <div class = "alert alert-success">add bursary/ new</div>
                        <div style = "width:40%; margin-left:32%;"> 
                            <form method = "POST" action = "add_bursary.php">  
                                ...
                                <div class = "form-group">
                                    <label>County</label>
                                    <select class="form-control" name="county" id="county" required = "required">
                                ...
                                <div class = "form-group">
                                    ...
                                    <select class="form-control" name="const" id="const" required = "required">
